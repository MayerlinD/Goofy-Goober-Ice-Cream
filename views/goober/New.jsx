    ...
    render(){
        return (
            ...
            <form method="POST" action="/goober">
                Flavor: <input type="text" name="name" placeholder='Name of Ice Cream Here'></input><br/>
                Description: <input type="text" name="color" placeholder='Color of Ice Cream Here'></input><br/>
